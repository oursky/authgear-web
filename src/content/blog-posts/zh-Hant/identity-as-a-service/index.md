...
<nav id="table-of-content">
    <ul>
        <li><a href="#def">什麼是 Identity as a Service（IDaaS）？</a></li>
        <li><a href="#why">為什麼 IDaaS 是必備方案？</a></li>
        <li><a href="#features">優秀 IDaaS 的關鍵功能</a></li>
        <li><a href="#future">IDaaS 的未來</a></li>
    </ul>
</nav>

<h2 id="def">什麼是 Identity as a Service（IDaaS）？</h2>
...
PWC 在 <a href="https://www.pwc.com/us/en/services/consulting/cybersecurity-risk-regulatory/library/seven-privacy-megatrends/rise-privacy-enforcement.html" target="_blank">2020 Privacy Megatrend 報告</a>指出，受隱私法規保護的人口正在快速增加。隨著更多國家強化法規，資料保護不再是選配，而是必須。IDaaS 能幫助企業更容易跟上隱私法變化，避免高昂法律風險。
