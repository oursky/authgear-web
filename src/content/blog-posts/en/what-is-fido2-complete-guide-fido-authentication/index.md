...
For development teams evaluating passwordless authentication, Authgear provides built-in support for [passkeys](/features/passkeys) and FIDO2 security keys alongside other [user authentication methods](/post/top-three-types-of-user-authentication-methods) like [TOTP](/post/what-is-totp), [SMS OTP](/post/sms-authentication-should-you-implement), and [social login](/post/social-login-guide). You can add FIDO2 authentication to your app without building the WebAuthn integration from scratch.
