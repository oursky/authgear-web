...
**Migration status (2026-04-21):** Phases 1 + 2a + 2b + 2c (1/2/3) shipped on branch `migration/nextjs-to-astro`. Home + 13 static + 4 compare + 7 solutions + 19 features pages live in both locales. 3 new tab/accordion islands hydrated. `SmsCostCalculator` stubbed on `reduce-sms-otp-cost` pending Phase 2d. Phase 2d (tools + SMS calculator) plan pending.
