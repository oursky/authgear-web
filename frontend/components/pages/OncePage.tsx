...
import LogoMarquee, { ONCE_SDK_MARQUEE_LOGOS } from '@/components/LogoMarquee';
import OncePageFaq from '@/components/pages/OncePageFaq';
import OnceSdkFrameworkHarness from '@/components/pages/OnceSdkFrameworkHarness';
...
export default async function OncePage({ locale }: Props) {
  ...
  const cloudHomeHref = localizedPath(locale, '/');
      ...
      <div className="page-wrapper">
        ...
        <div className="w-layout-blockcontainer popup-container w-container">
          ...
          <div className="w-layout-hflex waitlist-popup"><img src="/images/AuthgearONCE_logo_dark.svg" loading="lazy" alt="" />
            <div className="text-block-64">{t.rich('waitlistTitle', { br: () => <br /> })}</div>
            <div className="authgear-once-form w-form">
              <form id="wf-form-Once-Waitlist" name="wf-form-Once-Waitlist-2" data-name="Once Waitlist" method="get" className="authgear-once"><input className="text-field-2 w-input" maxLength={256} name="Email" data-name="Email" placeholder={t('emailPlaceholder')} type="email" id="Email" required />
                <div id="w-node-f51c9bed-a02e-8eab-fd22-370ce9d91b0e-85a0aff6" data-sitekey="6LdonPYqAAAAAGzNsg7cDyHi5VTueApPzHoOx0Y4" className="w-form-formrecaptcha recaptcha long g-recaptcha g-recaptcha-error g-recaptcha-disabled"></div><input type="submit" data-wait={t('submitWait')} className="submit-button w-button" value={t('submitButton')} />
              </form>
          ...
          <div className="section home-hero dark once-banner new-kv">
                ...
                <div className="div-block-22">
                  <div className="w-layout-blockcontainer product-switch-outer w-container">
                    <div className="w-layout-hflex product-switch">
                      <a href={cloudHomeHref} className="flex-block-66 w-inline-block">
                        ...
                        <div className="text-block-63">{tHome('productSwitchCloud')}</div>
                      </a>
                      <div className="w-layout-hflex flex-block-66 active">
                        ...
                        <div className="text-block-63 active">{tHome('productSwitchServer')}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-layout-blockcontainer once-subititle w-container">
                    <p className="once-h1">{t.rich('heroTagline', {
                      br: () => <br />,
                      gradient: (chunks) => <span className="once-gradient">{chunks}</span>,
                    })}</p>
                    <p className="paragraph-large home-hero text-afb7ff ibm-plex-sans new-kv-desc once-mobile">{t('heroDescription')}</p>
                    <div className="w-embed">
                      <a href="https://www.producthunt.com/products/authgear-once/reviews?utm_source=badge-product_review&utm_medium=badge&utm_source=badge-authgear&#0045;once" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/product_review.svg?product_id=1080383&theme=light" alt={t('productHuntBadgeAlt')} style={{"width": "250px", "height": "54px"}} width="250" height="54" /></a>
                    </div>
                  </div>
                  <div className="w-layout-hflex home-hero-cta-wrapper once-cta-wrapper">
                    <a href="https://accounts.portal.authgear.com/signup" className="button-primary home-hero new-home radius-16 once-special-button w-button">{t('ctaTryCloud')}</a>
                    <a href="#system-installation" className="developer-docs">{t('ctaInstallDocs')}</a>
                  </div>
                </div>
                <div className="once-price-float">
                  <div className="w-layout-hflex once-price"><img src="/images/AuthgearONCE_logo_small.svg" loading="lazy" alt="" className="pricing---once-logo" />
                    <div className="w-layout-blockcontainer once-price-text w-container">
                      <div className="oce-price-text">$ <span className="price-number">299</span> {t('priceSuffix')}</div>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="w-layout-blockcontainer container-1449 w-container">
                        <div className="w-layout-blockcontainer included-feature w-container"><img src="/images/once_box-checked.svg" loading="lazy" alt="" />
                          <div className="included-feature-text">{t('included1')}</div>
                        </div>
                        <div className="w-layout-blockcontainer included-feature w-container"><img src="/images/once_box-checked.svg" loading="lazy" alt="" />
                          <div className="included-feature-text">{t('included2')}</div>
                        </div>
                        <div className="w-layout-blockcontainer included-feature w-container"><img src="/images/once_box-checked.svg" loading="lazy" alt="" />
                          <div className="included-feature-text">{t('included3')}</div>
                        </div>
                        <div className="w-layout-blockcontainer included-feature w-container"><img src="/images/once_box-checked.svg" loading="lazy" alt="" />
                          <div className="included-feature-text">{t('included4')}</div>
                        </div>
                        <div className="w-layout-blockcontainer included-feature w-container"><img src="/images/once_box-checked.svg" loading="lazy" alt="" />
                          <div className="included-feature-text">{t('included5')}</div>
                        </div>
                      </div>
                    </div>
                    <a href="https://once-license.authgear.com/v1/stripe/checkout" target="_blank" className="once-button w-button">{t('checkout')}</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="container-default-inner once-container-bottom">
              <div className="w-layout-blockcontainer remember w-container">
                <h2 className="once-h2">{t('rememberHeading')}</h2>
                <div className="once-subtitle once-purple">{t.rich('rememberSub', {
                  highlight: (chunks) => <span className="once-highlight">{chunks}</span>,
                })}</div>
                <div className="text-block-53">{t('rememberWhyDevs')}</div>
                <div className="w-layout-grid once-grid">
                  <div className="remember-card"><img src="/images/once_remember-software-fees_1.svg" loading="lazy" alt="" />
                    <div className="remember-card-headlines">{t('rememberCard1Title')}</div>
                    <div className="text-block-54">{t('rememberCard1Desc')}</div>
                  </div>
                  <div className="remember-card"><img src="/images/once_remember-software-vendor_1.svg" loading="lazy" alt="" />
                    <div className="remember-card-headlines">{t('rememberCard2Title')}</div>
                    <div className="text-block-54">{t('rememberCard2Desc')}</div>
                  </div>
                  <div className="remember-card"><img src="/images/once_remember-software-costs_1.svg" loading="lazy" alt="" />
                    <div className="remember-card-headlines">{t('rememberCard3Title')}</div>
                    <div className="text-block-54">{t('rememberCard3Desc')}</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="container-default-inner once-container-bottom once-container-top">
              <h2 className="once-h2">{t.rich('allInOneHeading', {
                gradient: (chunks) => <span className="once-gradient">{chunks}</span>,
              })}</h2>
              <div className="once-subtitle">{t('allInOneSubtitle')}</div>
              <div className="w-layout-vflex flex-block-58">
                <div id="w-node-_2add4d7f-a071-9fa7-592d-d56710479f26-85a0aff6" className="w-layout-vflex high"><img src="/images/once_onetimepayment-sso_1.svg" loading="lazy" alt="" />
                  <h3 className="all-in-one-h3">{t('featureSsoTitle')}</h3>
                  <div className="all-in-one-description">{t('featureSsoDesc')}</div><img src="/images/once_onetimepayment-sso2x.webp" loading="lazy" alt="" />
                </div>
                <div id="w-node-_2add4d7f-a071-9fa7-592d-d56710479f2d-85a0aff6" className="w-layout-vflex high"><img src="/images/once_onetimepayment-passkeys_1.svg" loading="lazy" alt="" />
                  <h3 className="all-in-one-h3">{t('featurePasskeysTitle')}</h3>
                  <div className="all-in-one-description">{t('featurePasskeysDesc')}</div><img src="/images/once_onetimepayment-passkeys2x.webp" loading="lazy" alt="" />
                </div>
                ...
                <div id="w-node-_2add4d7f-a071-9fa7-592d-d56710479f3b-85a0aff6" className="w-layout-vflex high low">
                  <div className="w-layout-vflex"><img src="/images/once_onetimepayment-usermanagement_1.svg" loading="lazy" alt="" className="image-80" />
                    <h3 className="all-in-one-h3">{t('featurePortalTitle')}</h3>
                    <div className="all-in-one-description">{t('featurePortalDesc')}</div>
                ...
                <div id="w-node-_2add4d7f-a071-9fa7-592d-d56710479f43-85a0aff6" className="w-layout-vflex high low">
                  <div className="w-layout-vflex"><img src="/images/once_onetimepayment-security_1.svg" loading="lazy" alt="" className="image-80" />
                    <h3 className="all-in-one-h3">{t('featureSecurityTitle')}</h3>
                    <div className="all-in-one-description">{t('featureSecurityDesc')}</div>
            ...
            <div className="container-default-inner once-container-bottom once-container-top once-container-60-gap">
              <div className="w-layout-blockcontainer once-inner-container w-container">
                <h2 className="once-h2">{t.rich('agenciesHeading', {
                  gradient: (chunks) => <span className="once-gradient">{chunks}</span>,
                })}</h2>
                <div className="w-layout-grid grid-16">
                  <div className="w-layout-blockcontainer small-teams-card w-container"><img src="/images/once_build-for-developer-costs.svg" loading="lazy" alt="" className="image-75" />
                    <div className="w-layout-blockcontainer w-container">
                      <div className="who-choose-title small-team">{t('agencyCard1Title')}</div>
                      <div className="who-choose-des">{t('agencyCard1Desc')}</div>
                    </div>
                  </div>
                  <div className="w-layout-blockcontainer small-teams-card w-container"><img src="/images/once_build-for-developer-project_1.svg" loading="lazy" alt="" className="image-75" />
                    <div className="w-layout-blockcontainer w-container">
                      <div className="who-choose-title small-team">{t('agencyCard2Title')}</div>
                      <div className="who-choose-des">{t('agencyCard2Desc')}</div>
                    </div>
                  </div>
                  <div className="w-layout-blockcontainer small-teams-card w-container"><img src="/images/once_build-for-developer-experience.svg" loading="lazy" alt="" className="image-75" />
                    <div className="w-layout-blockcontainer w-container">
                      <div className="who-choose-title small-team">{t('agencyCard3Title')}</div>
                      <div className="who-choose-des">{t('agencyCard3Desc')}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="container-default-inner once-container-bottom once-container-top once-container-60-gap">
              <div>
                <h2 className="once-h2">{t.rich('sdkHeading', {
                  gradient: (chunks) => <span className="once-gradient">{chunks}</span>,
                })}</h2>
                <div className="once-subtitle">{t('sdkSubtitle')}</div>
              </div>
              <div className="w-layout-blockcontainer once-inner-container w-container">
                <div className="w-layout-hflex flex-block-59">
                  <div className="w-layout-vflex flex-block-60">
                    <div className="who-choose-title no-margin">{t('sdkBulletIntro')}</div>
                    <div className="w-layout-vflex flex-block-61">
                      <div className="w-layout-hflex flex-block-62"><img src="/images/once_build-for-developer-check.svg" loading="lazy" alt="" />
                        <div className="who-choose-des">{t('sdkBullet1')}</div>
                      </div>
                      <div className="w-layout-hflex flex-block-62"><img src="/images/once_build-for-developer-check.svg" loading="lazy" alt="" />
                        <div className="who-choose-des">{t('sdkBullet2')}</div>
                      </div>
                      <div className="w-layout-hflex flex-block-62"><img src="/images/once_build-for-developer-check.svg" loading="lazy" alt="" />
                        <div className="who-choose-des">{t('sdkBullet3')}</div>
                      </div>
                      <div className="w-layout-hflex flex-block-62"><img src="/images/once_build-for-developer-check.svg" loading="lazy" alt="" />
                        <div className="who-choose-des">{t('sdkBullet4')}</div>
                      </div>
                      <div className="w-layout-hflex flex-block-62"><img src="/images/once_build-for-developer-check.svg" loading="lazy" alt="" />
                        <div className="who-choose-des">{t('sdkBullet5')}</div>
                      </div>
                    </div>
                    <div className="once-subtitle left">{t('sdkDocsParagraph')}</div>
                    <div className="w-layout-hflex home-hero-cta-wrapper once-cta-wrapper">
                      <a href="https://docs.authgear.com/" target="_blank" className="button-primary home-hero new-home radius-16 once-special-button w-button">{t('seeDocs')}</a>
                      <a href="https://docs.authgear.com/get-started/5-minute-guide" target="_blank" className="link-block _5-min w-inline-block"><img src="/images/Play---Iconly-Pro.svg" loading="lazy" alt="" />
                        <div className="text-block-52 _5-min-text">{t('seeFiveMinuteGuide')}</div>
                      </a>
                    </div>
                  </div>
                  <OnceSdkFrameworkHarness>
                  <div className="w-layout-hflex grid-14 gap-20 once-sdk-framework-grid">
                    <div className="w-layout-vflex flex-block-46">
                      <div className="w-layout-grid grid-15">
                        <div className="w-layout-blockcontainer system react w-container" data-once-sdk="react">
                          <div className="w-layout-blockcontainer system-inner w-container">
                            ...
                            <div className="system-name">{t('techReact')}</div>
                          </div>
                        </div>
                        <div className="w-layout-blockcontainer system vue w-container" data-once-sdk="vue">
                          <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                            ...
                            <div className="system-name">{t('techVue')}</div>
                          </div>
                        </div>
                        <div className="w-layout-blockcontainer system angular w-container" data-once-sdk="angular">
                          <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                            ...
                            <div className="system-name">{t('techAngular')}</div>
                          </div>
                        </div>
                        <div className="w-layout-blockcontainer system react-native w-container" data-once-sdk="react-native">
                          <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                            ...
                            <div className="system-name">{t('techReactNative')}</div>
                          </div>
                        </div>
                        <div className="w-layout-blockcontainer system flutter w-container" data-once-sdk="flutter">
                          <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                            ...
                            <div className="system-name">{t('techFlutter')}</div>
                          </div>
                        </div>
                        <div className="once-sdk-native-pills">
                          <div className="w-layout-blockcontainer system ios w-container" data-once-sdk="ios">
                            <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                              ...
                              <div className="system-name">{t('techIos')}</div>
                            </div>
                          </div>
                          <div className="w-layout-blockcontainer system android w-container" data-once-sdk="android">
                            <div className="w-layout-blockcontainer system-inner inactive-system w-container">
                              ...
                              <div className="system-name">{t('techAndroid')}</div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="w-layout-blockcontainer code-outer w-container">
                      <div className="w-layout-blockcontainer code-inner w-container">
                        <div className="w-layout-blockcontainer code-div w-container">
                          <div className="w-layout-blockcontainer code-wrapper react react-code w-container" data-once-panel="react">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.react} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper vue w-container" data-once-panel="vue">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.vue} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper angular w-container" data-once-panel="angular">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.angular} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper react-native w-container" data-once-panel="react-native">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES['react-native']} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper flutter w-container" data-once-panel="flutter">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.flutter} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper ios w-container" data-once-panel="ios">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.ios} />
                          </div>
                          <div className="w-layout-blockcontainer code-wrapper android w-container" data-once-panel="android">
                            <OnceSdkCode source={ONCE_SDK_CODE_SAMPLES.android} />
                          </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="w-layout-hflex flex-block-47 once-sdk-logo-marquee">
                  ...
                  <LogoMarquee
                    logos={ONCE_SDK_MARQUEE_LOGOS}
                    showReadStoryCta={false}
                    rootClassName="w-layout-hflex"
                    logoImgClassName="logo image-76"
                  />
                </div>
                </div>
              </div>
          ...
          <div className="once-last-container">
            <div className="container-default once">
              <section id="system-installation" className="w-layout-hflex flex-block-63 tbc">
                <div className="div-block-21 tbc">
                  <h2 className="once-h2 left-h2 tbc">{t('systemHeading')}</h2>
                  <div className="once-subtitle left tbc">{t('systemSubtitle')}</div>
                </div>
                <div style={{"paddingTop": "56.17021276595745%"}} className="w-embed-youtubevideo"><iframe src="https://www.youtube.com/embed/VpSZYHJu7DM?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameBorder={0} style={{"position": "absolute", "left": "0", "top": "0", "width": "100%", "height": "100%", "pointerEvents": "auto"}} allow="autoplay; encrypted-media" allowFullScreen title={t('installVideoTitle')}></iframe></div>
                <div className="w-layout-blockcontainer container-1455 w-container">
                  <div className="w-layout-vflex flex-block-53">
                    <div className="w-layout-vflex flex-block-54">
                      <div className="text-block-57">{t('tableRequirement')}</div>
                      <div className="text-block-57">{t('tableMinimum')}</div>
                      <div className="text-block-57">{t('tableRecommended')}</div>
                    </div>
                    ...
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin"><img src="/images/once_requirement-cpu.svg" loading="lazy" alt="" className="image-78" />
                        <div className="who-choose-des">{t('specCpu')}</div>
                      </div>
                      <div className="text-block-57">{t('specCpuMin')}</div>
                      <div className="text-block-57">{t('specCpuRec')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin"><img src="/images/once_requirement-ram_1.svg" loading="lazy" alt="" className="image-78" />
                        <div className="who-choose-des">{t('specRam')}</div>
                      </div>
                      <div className="text-block-57">{t('specRamMin')}</div>
                      <div className="text-block-57">{t('specRamRec')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin"><img src="/images/once_requirement-storage.svg" loading="lazy" alt="" className="image-78" />
                        <div className="who-choose-des">{t('specStorage')}</div>
                      </div>
                      <div className="text-block-57">{t('specStorageMin')}</div>
                      <div className="text-block-57">{t('specStorageRec')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin"><img src="/images/once_requirement-database.svg" loading="lazy" alt="" className="image-78" />
                        <div className="who-choose-des">{t('specDatabase')}</div>
                      </div>
                      <div className="text-block-57">{t('specPgMin')}</div>
                      <div className="text-block-57">{t('specPgRec')}</div>
                    </div>
                  </div>
                </div>
                <div className="w-layout-vflex container-1455 mobile-table">
                  <div className="w-layout-vflex flex-block-53">
                    <div className="w-layout-vflex flex-block-54">
                      <div className="who-choose-des">{t('tableRequirement')}</div>
                      <div className="w-layout-hflex flex-block-52 no-margin"><img src="/images/once_requirement-cpu.svg" loading="lazy" alt="" className="image-78" />
                        <div className="who-choose-des">{t('specCpu')}</div>
                      </div>
                    </div>
                    ...
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin">
                        <div className="who-choose-des">{t('tableMinimum')}</div>
                      </div>
                      <div className="who-choose-des">{t('specCpuMin')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin">
                        <div className="who-choose-des">{t('tableRecommended')}</div>
                      </div>
                      <div className="who-choose-des">{t('specCpuRec')}</div>
                    </div>
                  </div>
                  <div className="w-layout-vflex flex-block-53">
                    <div className="w-layout-vflex flex-block-54">
                    ...
                    <div className="w-layout-vflex flex-block-54">
                      ...
                      <div className="who-choose-des">{t('specRamMin')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin">
                      ...
                      <div className="who-choose-des">{t('specRamRec')}</div>
                    </div>
                  </div>
                  <div className="w-layout-vflex flex-block-53">
                    <div className="w-layout-vflex flex-block-54">
                    ...
                    <div className="w-layout-vflex flex-block-54">
                      ...
                      <div className="who-choose-des">{t('specStorageMin')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin">
                      ...
                      <div className="who-choose-des">{t('specStorageRec')}</div>
                    </div>
                  </div>
                  <div className="w-layout-vflex flex-block-53">
                    <div className="w-layout-vflex flex-block-54">
                    ...
                    <div className="w-layout-vflex flex-block-54">
                      ...
                      <div className="who-choose-des">{t('specPgMin')}</div>
                    </div>
                    <div className="w-layout-blockcontainer container-1456 w-container"></div>
                    <div className="w-layout-vflex flex-block-54">
                      <div className="w-layout-hflex flex-block-52 no-margin">
                      ...
                      <div className="who-choose-des">{t('specPgRec')}</div>
                    </div>
                  </div>
                </div>
              </section>
            ...
            <div className="container-default once">
              <div className="waitlist">
                <h2 className="once-h2">{t('getStartedTitle')}</h2>
                <div className="once-subtitle">{t('getStartedSubtitle')}</div>
                <a href="https://once-license.authgear.com/v1/stripe/checkout" target="_blank" className="once-button bottom-inverse w-button">{t('checkout')}</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-layout-vflex section-14"><img src="/images/AuthgearONCE_logo_small.svg" loading="lazy" alt="" className="image-84" />
          <div className="oce-price-text bottom">$ <span className="price-number">299</span> {t('priceSuffix')}</div>
          <a href="https://once-license.authgear.com/v1/stripe/checkout" target="_blank" className="once-button inverse w-button">{t('checkout')}</a>
        </div>
