...
export default function Auth0AlternativePage(_props: Props) {
  const t = useTranslations('Auth0Alternative');
            ...
            <div className="div-block-25">
              ...
              <div className="w-layout-grid table-header table-content">
                ...
                <div className="compare-table-multi-info">
                  <img src="/images/compare_table-false.svg" loading="lazy" alt="" />
                  <div className="compare-table-text-light title">{t('tableEssentialsPlanRequired')}</div>
                </div>
              </div>
              <div className="w-layout-grid table-header table-content">
                ...
                <div className="compare-table-multi-info">
                  <img src="/images/compare_table-false.svg" loading="lazy" alt="" />
                  <div className="compare-table-text-light title">{t('tableEnterprisePlanRequired')}</div>
                </div>
              </div>
              <div className="w-layout-grid table-header table-content">
              ...
              <div className="w-layout-grid table-header table-content">
                <div className="table-text title">{t('tableAccountDedupTitle')}</div>
                <img src="/images/compare_table-check-blue.svg" loading="lazy" alt="" />
                <div className="table-text">
                  {t('tableAccountDedupAuth0Line1')}
                  <br />
                  {t('tableAccountDedupAuth0Line2')}
                </div>
              </div>
              <div className="w-layout-grid table-header table-content">
              ...
              <div className="w-layout-grid table-header table-content">
                ...
                <div className="table-text">
                  {t('tableLoginExpAuth0Line1')}
                  <br />
                  {t('tableLoginExpAuth0Line2')}
                </div>
              </div>
              <div className="w-layout-grid table-header table-content">
