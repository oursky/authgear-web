...
export default function OktaAlternativePage(_props: Props) {
  const t = useTranslations('OktaAlternative');
          ...
          <div className="container-default-inner px-0 gap-0 pb-0">
            ...
            <div className="div-block-25">
              ...
              <div className="w-layout-grid table-header table-content">
                ...
                <div className="table-text">{t('tableScalingOkta')}</div>
              </div>
              <div className="w-layout-grid table-header table-content">
                <div className="table-text title">{t('tablePhoneTitle')}</div>
              ...
              <div className="w-layout-grid table-header table-content">
                ...
                <img src="/images/compare_table-check-blue.svg" loading="lazy" alt="" />
                <div className="table-text">{t('tableMfaOktaNote')}</div>
              </div>
              <div className="w-layout-grid table-header table-content">
              ...
              <div className="w-layout-grid table-header table-content">
                <div className="table-text title">{t('tableSsoTitle')}</div>
                <img src="/images/compare_table-check-blue.svg" loading="lazy" alt="" />
                <img src="/images/compare_table-check-gray.svg" loading="lazy" alt="" />
              </div>
              <div className="w-layout-grid table-header table-content">
                ...
                <div className="table-text dash">{t('tableDash')}</div>
              </div>
              <div className="w-layout-grid table-header table-content">
