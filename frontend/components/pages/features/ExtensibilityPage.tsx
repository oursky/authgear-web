...
export default function ExtensibilityPage(_props: Props) {
  const t = useTranslations('Extensibility');
  ...
  return (
    <>
              ...
              <div className="ds-hero-banner__row">
                <div className="ds-hero-banner__body">
                  ...
                  <div className="ds-hero-banner__ctas">
                    <a
                      href="https://portal.authgear.com/?utm_source=feature-extensibility&utm_medium=link&utm_campaign=start-for-free"
                      target="_blank"
                      rel="noreferrer"
                ...
                <img
                  ...
                  src="/images/features-extensibility-banner-kv2x.webp"
                  srcSet="/images/features-extensibility-banner-kv2x-p-500.webp 500w, /images/features-extensibility-banner-kv2x-p-800.webp 800w, /images/features-extensibility-banner-kv2x-p-1080.webp 1080w, /images/features-extensibility-banner-kv2x.webp 1244w"
                  width={738}
        ...
        <div className="ds-container">
          <div className="ds-feature-callout">
            <div className="ds-feature-callout__title">
              <h2 className="heading-on-dark">{t('calloutTitle')}</h2>
            </div>
            <div className="ds-feature-callout__body">
              <p className="section-lede-on-dark">{t('calloutDesc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="ds-section ds-bg-light-blue">
        <div className="ds-container ds-container--split-stack ds-container--split-stack--title-gap-m">
          <div className="title-content">
            <h2 className="heading-on-light">{t('hooksTitle')}</h2>
            <p className="section-lede-on-light">{t('hooksDesc')}</p>
          </div>
          <div className="ds-split-stack__rows">
            <div className="ds-split ds-split-row ds-split-row--surface-light">
              <div className="ds-split-row__media">
                <img src="/images/features-extensibility-hooks-12x.webp" loading="lazy" width={280} sizes="(max-width: 479px) 100vw, 280px" alt="" srcSet="/images/features-extensibility-hooks-12x-p-500.webp 500w, /images/features-extensibility-hooks-12x-p-800.webp 800w, /images/features-extensibility-hooks-12x.webp 1120w" className="ds-split-row__img" />
              </div>
              <div className="ds-split-row__body">
                <h3 className="heading-on-light">{t('nonBlockingTitle')}</h3>
                <ul role="list" className="ds-body-bullet-list">
                  <li>{t('nonBlockingItem1')}</li>
                </ul>
                <p className="section-lede-on-light"><span className="code-label">user.created</span>, <span className="code-label">user.profile.updated</span>, <span className="code-label">user.authenticated</span>, <span className="code-label">user.disabled</span>, <span className="code-label">user.reenabled</span>, {t('etc')}</p>
              </div>
            </div>
            <div className="ds-split ds-split-row ds-split-row--reverse ds-split-row--surface-light">
              <div className="ds-split-row__media">
                <img src="/images/features-extensibility-hooks-22x.webp" loading="lazy" width={280} sizes="(max-width: 479px) 100vw, 280px" alt="" srcSet="/images/features-extensibility-hooks-22x-p-500.webp 500w, /images/features-extensibility-hooks-22x-p-800.webp 800w, /images/features-extensibility-hooks-22x-p-1080.webp 1080w, /images/features-extensibility-hooks-22x.webp 1120w" className="ds-split-row__img" />
              </div>
              <div className="ds-split-row__body">
                <h3 className="heading-on-light">{t('blockingTitle')}</h3>
                <ul role="list" className="ds-body-bullet-list">
                  <li>{t('blockingItem1')}</li>
                </ul>
                <p className="section-lede-on-light"><span className="code-label">user.pre_created</span>, <span className="code-label">user.profile.pre_updated</span>, <span className="code-label">user.pre_schedule_deletion</span>, <span className="code-label">oidc.jwt.pre_create</span>, {t('etc')}</p>
              </div>
            </div>
            <div className="ds-split ds-split-row ds-split-row--surface-light">
              <div className="ds-split-row__media">
                <img src="/images/features-extensibility-hooks-32x.webp" loading="lazy" width={560} sizes="(max-width: 767px) 100vw, 560px" alt="" srcSet="/images/4baaeb37e3dc49d716925e6d451e0434_features-extensibility-hooks-32x-p-500.webp 500w, /images/4baaeb37e3dc49d716925e6d451e0434_features-extensibility-hooks-32x-p-800.webp 800w, /images/features-extensibility-hooks-32x.webp 1120w" className="ds-split-row__img" />
              </div>
              <div className="ds-split-row__body">
                <h3 className="heading-on-light">{t('buildTitle')}</h3>
                <ul role="list" className="ds-body-bullet-list">
                  <li><strong>{t('buildItem1Title')}</strong><br />{t('buildItem1Desc')}</li>
                  <li><strong>{t('buildItem2Title')}</strong><br />{t('buildItem2Desc')}</li>
                  <li><strong>{t('buildItem3Title')}</strong><br />{t('buildItem3Desc')}</li>
                  <li><strong>{t('buildItem4Title')}</strong><br />{t('buildItem4Desc')}</li>
                </ul>
              </div>
            </div>
            <div className="ds-split ds-split-row ds-split-row--reverse ds-split-row--surface-light">
              <div className="ds-split-row__media">
                <img src="/images/features-extensibility-adminapi2x.webp" loading="lazy" width={624} sizes="(max-width: 767px) 100vw, 624px" alt="" srcSet="/images/features-extensibility-adminapi2x-p-500.webp 500w, /images/features-extensibility-adminapi2x-p-800.webp 800w, /images/features-extensibility-adminapi2x-p-1080.webp 1080w, /images/features-extensibility-adminapi2x.webp 1248w" className="ds-split-row__img" />
              </div>
              <div className="ds-split-row__body">
                <h3 className="heading-on-light">{t('adminApiTitle')}</h3>
                <p className="section-lede-on-light">{t('adminApiDesc')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="ds-section passwordless-section-dark-bg">
        <div className="ds-container">
          <div className="title-content">
            <h2 className="heading-on-dark">{t('devExpTitle')}</h2>
          </div>
          <div className="ds-grid-3">
            <div className="svg-card">
              ...
              <div className="ds-svg-card-content">
                <div className="ds-svg-card-title">{t('devExp1Title')}</div>
                <div className="ds-svg-card-description">{t('devExp1Desc')}</div>
              </div>
            </div>
            <div className="svg-card">
              <div className="icon-w48 w-embed"><svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" fill="none">
              ...
              <div className="ds-svg-card-content">
                <div className="ds-svg-card-title">{t('devExp2Title')}</div>
                <div className="ds-svg-card-description">{t('devExp2Desc')}</div>
              </div>
            </div>
            <div className="svg-card">
              <div className="icon-w48 w-embed"><svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" fill="none">
              ...
              <div className="ds-svg-card-content">
                <div className="ds-svg-card-title">{t('devExp3Title')}</div>
                <div className="ds-svg-card-description">{t('devExp3Desc')}</div>
              </div>
            </div>
          </div>
        </div>
