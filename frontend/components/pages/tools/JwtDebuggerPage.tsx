...
export default function JwtDebuggerPage(_props: { locale: string }) {
  const t = useTranslations('Tools.jwtJwe');
  const policy = (
    <>
      {t('policyPrefix')}
        ...
        steps={[
          ...
          { step: t('s3Label'), title: t('s3Title'), items: [t('s3i1')] },
          {
            ...
            items: [
              <>
                {t('s4i1Part1')}
                <Link href={t('s4GuideLink')}>{t('s4GuideLinkLabel')}</Link>
                {t('s4i1Part2')}
              </>,
            ],
          },
      ...
      <ToolFaq>
        <div className="w-layout-vflex tools-faq">
          <ToolFaqCard
            ...
            title={
              <>
                <Link href="/post/jwt-authentication-a-secure-scalable-solution-for-modern-applications">
                  {t('faqJwtLinkText')}
                </Link>{' '}
                {t('faqJwtTitleSuffix')}
              </>
          ...
          >
            <div className="tools-faq-content">
              {t('faqJwtBodyP1')}
              <Link href={t('faqJwtBodyLinkMidHref')}>{t('faqJwtBodyLinkMid')}</Link>
              {t('faqJwtBodyP2')}
            </div>
