...
<script type="application/ld+json">
 ...
        "image":{
            "@type":"ImageObject",
            "url":"https://uploads-ssl.webflow.com/60658b47b03f0c77e8c14884/63c3f77c4553f67cefce1e8c_session-management.jpeg",
            "width":1223,
            "height":583
        },
        "datePublished":"2023-01-15",
        "dateModified":"2022-01-15",
        "description":"Session management involves managing requests between a user and web-based app or service. Learn about best practices of session management and the attacks associated with it.",
        "author":{
 ...
            <ul>
                <li><a href="#hijacking">Session Hijacking</a></li>
                <li><a href="#fixation">Session Fixation</a></li>
            </ul>
        </li>
        <li><a href="#best-practices">Best Practices of Implementing Session Management</a>
            <ul>
                <li><a href="#session-id">Properties of Session ID</a></li>
                <li><a href="#attributes">Attributes of Cookies</a></li>
                <li><a href="#new-id">Generation of New Session IDs</a></li>
            </ul>
        </li>
        <li><a href="#authgear">How Session Management Works with Authgear</a></li>
        <li><a href="#cta">Securing Session Management and Authentication with Authgear</a></li>
    </ul>
 </nav>
...
<h2 id="definition">How Does Session Management Work?</h2>
...
<h2 id="cyberattacks">Threats and Cyber Attacks Related to Session Management</h2>

<!--FIGURE-->![](./figure-2.jpeg)<!--/FIGURE-->

<h3 id="hijacking">Session Hijacking</h3>
...
<h2 id="best-practices">Best Practices of Implementing Session Management</h2>
...
<h3 id="session-id">Properties of Session ID</h3>
...
<h3 id="attributes">Attributes of Cookies</h3>
...
<h3 id="new-id">Generation of New Session IDs</h3>
...
<h2 id="authgear">How Session Management Works with Authgear</h2>
...
<h2 id="cta">Securing Session Management and Authentication with Authgear</h2>
