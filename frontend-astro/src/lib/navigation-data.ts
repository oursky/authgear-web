...
export const footerStrings: Record<string, Record<string, string>> = {
  ...
  security: { en: 'Security & Compliance', 'zh-TW': '安全性與合規' },
  acceptableUsePolicy: { en: 'Acceptable Use Policy', 'zh-TW': '合理使用政策' },
  complianceText: {
    en: 'Authgear is both ISO 27001 and SoC 2 Type II compliant.',
    'zh-TW': 'Authgear 已通過 ISO 27001 與 SoC 2 Type II 認證。',
  },
  passkeyPledgeAlt: { en: 'Passkey Pledge Partner', 'zh-TW': 'Passkey Pledge 合作夥伴' },
  termsOfService: { en: 'Terms', 'zh-TW': '服務條款' },
  privacyPolicy: { en: 'Privacy', 'zh-TW': '隱私權政策' },
  dataPrivacy: { en: 'Data Privacy', 'zh-TW': '資料隱私' },
  enterpriseLicenses: { en: 'Enterprise Licenses', 'zh-TW': '企業授權' },
  sla: { en: 'SLA', 'zh-TW': 'SLA' },
  ...
  copyright: { en: 'Authgear. All rights reserved.', 'zh-TW': 'Authgear。保留所有權利。' },
};
